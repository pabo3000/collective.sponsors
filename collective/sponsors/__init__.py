...
from collective.sponsors import config
...
sponsorsMessageFactory = MessageFactory('collective.sponsors')

setDefaultRoles('collective.sponsors: Add Sponsor', ['Manager', 
                                                     'Contributor', 
                                                     'Site Administrator', 
                                                     'Owner'])
